...
public class DecisionStructures {
	...
	public static void main(String[] args) {
		...
		/*
		 * if (number == 5) { JOptionPane.showMessageDialog(null, "The number is exactly 5!"); }
		 * else if (number > 10) { JOptionPane.showMessageDialog(null, "The number is greater than 10!"); }
		 * else if(number > 5) {
